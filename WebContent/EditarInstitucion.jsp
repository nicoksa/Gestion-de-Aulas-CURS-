	 ...
	 <jsp:include page="errorMessage.jsp" />
        ...
        <main b-dk557gbzy5="" role="main" class="w-full px-4 pt-2">
        	<section class="flex min-h-dvh w-full flex-col items-center">
			    <h2 class="w-full bg-gradient-to-tr from-zinc-800 to-zinc-500 p-4 text-center text-4xl font-bold text-gray-50">EDITAR INSTITUCION</h2>
			    <form class="flex h-full w-2/3 flex-col items-center justify-center rounded-md py-4" method="POST" action="ServletInstituciones?Param=list">
			        ...
			        <div class="flex w-2/3 flex-col mb-2 self-center">
			            ...
			            <input class="border-2 mx-1 rounded-md border-gray-900 p-1" type="text" data-val="true" data-val-required="The Nombre de la Institucion field is required." id="Name" name="Name" value="<%=institucion.getNombre() %>" required>
			            <span class="text-red-600 field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
			        </div>
			
			          <div class="flex w-2/3 justify-between">
			            <button type="submit"  name="idAeditar" value="<%= institucion.getId() %> " class="mt-3 w-48 h-11 rounded-md border border-transparent bg-gradient-to-tr from-sky-800 to-sky-500 px-4 py-2 gap-2 text-center text-l text-white shadow-md transition-all hover:shadow-lg hover:bg-slate-700 focus:bg-slate-700 focus:shadow-none active:bg-slate-700 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none flex items-center justify-center">
			                <i class="fa fa-pencil" aria-hidden="true"></i>  Editar Institucion
			            </button>
			            <a
			    ...
			    <input name="__RequestVerificationToken" type="hidden" value="CfDJ8PsupENnyaxJsSE9YBIZHT6bqzYArdjGwc0l8OZb-8XFvdlDs3HjxiZqf5Y1YJfr9vkodUr92yrbcQadWqlcMjV9RGIqtT4E667W4jgWSCRcTyVgIsHEQdvbJ0PlnSIxtmhs7l2pGy7pYbNXNadKsYA"></form>
